...
class CocoData(torchvision.datasets.VisionDataset):
    ...
    def __getitem__(self, index: int):
        ...
        save_path = os.path.join(self.save_path, self.corruption, str(self.severity), 'val2017')
        corrupt_annotation_path = os.path.join(self.save_path, self.corruption, str(self.severity), 'annotations')
...
def get_args():
    ...
    parser.add_argument("--data_path", default=r"F:\Code\datasets\coco", type=str, help='path of the clean images')

    # Logging Parameters
    parser.add_argument("--save_path", default=r"coco_corrupted", type=str, help='the folder name of output')
...
if __name__ == '__main__':
    ...
    images_path = os.path.join(args.data_path, "val2017")
    annotations_path = os.path.join(args.data_path, "annotations", "instances_val2017.json")
    ...
    for corruption in get_corruption_names():
        ...
        for severity in range(5):
            dataset = CocoData(ann_path = annotations_path,root=images_path, transform=transforms,
